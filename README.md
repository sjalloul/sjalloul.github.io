...
The visual identity is an **engineering–editorial** system: a drafting-vellum
background, `Space Grotesk` display type, a `Newsreader` serif for reading, `IBM Plex
Mono` for labels, and a signature **ECG pulse trace** in the hero — a nod to the
cardiac-monitoring world the work comes from.
